# TCGLogging.psm1
# Shared logging module for TCG Cloud deployment scripts
...
function Start-TCGLogging {
    ...
    # Log start of script
    Write-TCGLog -Level Info -Message "===== $ScriptName started at $(Get-Date) =====" -LogFile $logFile
...
function Stop-TCGLogging {
    ...
    Write-TCGLog -Level Info -Message "===== $script:ScriptName completed at $(Get-Date) with exit code $ExitCode =====" -LogFile $LogFile
...
function Write-TCGLog {
    ...
    $logEntry = "[$timestamp][$Level][$script:ScriptName] $Message"
...
function Write-TCGDebug {
    ...
    Write-TCGLog -Level Debug -Message $Message -LogFile $LogFile
}
...
function Write-TCGInfo {
    ...
    Write-TCGLog -Level Info -Message $Message -LogFile $LogFile
}
...
function Write-TCGWarning {
    ...
    Write-TCGLog -Level Warning -Message $Message -LogFile $LogFile
}
...
function Write-TCGError {
    ...
    Write-TCGLog -Level Error -Message $errorMessage -LogFile $LogFile
}
...
function Write-TCGFatal {
    ...
    Write-TCGLog -Level Fatal -Message $errorMessage -LogFile $LogFile
}
...
Export-ModuleMember -Function Start-TCGLogging, Stop-TCGLogging, Write-TCGLog, Write-TCGDebug, Write-TCGInfo, Write-TCGWarning, Write-TCGError, Write-TCGFatal, Invoke-TCGScript 